...
class AdminCandidatosController {
    ...
    public function __construct() {
        // Verificar autenticación de administrador usando SessionManager
        $this->verificarAutenticacion();

        // Inicializar modelo
        $this->candidatoModel = new Candidatos();
    }

    /**
     * Verifica que el usuario esté autenticado como administrador usando SessionManager
     */
