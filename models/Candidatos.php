...
class Candidatos {
    ...
    /**
     * Alias para obtenerPorTipo - Mantiene compatibilidad con código existente
     * @param string $tipo Tipo de candidato (PERSONERO o REPRESENTANTE)
     * @return array Lista de candidatos
     */
    public function getCandidatosPorTipo($tipo) {
        return $this->obtenerPorTipo($tipo);
    }

    /**
     * Obtiene candidatos por tipo y grado específico
     * @param string $tipo Tipo de candidato (PERSONERO o REPRESENTANTE)
     * @param int $grado Grado específico
     * @return array Lista de candidatos
     */
    public function getCandidatosPorTipoYGrado($tipo, $grado) {
        return $this->obtenerPorTipo($tipo, $grado);
    }

    /**
     * Alias para obtenerPorId - Mantiene compatibilidad con código existente
     * @param int $id ID del candidato
     * @return array|null Datos del candidato o null si no existe
     */
