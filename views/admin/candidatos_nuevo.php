...
<head>
    ...
    <style>
        ...
        .sidebar-link { color: #adb5bd; text-decoration: none; display: block; padding: 0.75rem 1rem; border-radius: 0.25rem; transition: all 0.2s; }
        .sidebar-link:hover, .sidebar-link.active { color: white; background-color: rgba(255, 255, 255, 0.1); }
        .sidebar-link i { margin-right: 0.5rem; width: 20px; text-align: center; }
        .main-content { min-height: 100vh; }
        .content-header { background-color: white; box-shadow: 0 2px 5px rgba(0,0,0,0.05); padding: 1rem; margin-bottom: 1.5rem; }
        .card { border: none; border-radius: 10px; box-shadow: 0 0 15px rgba(0,0,0,0.05); margin-bottom: 1.5rem; }
        .badge-tipo { font-size: 0.75rem; padding: 0.25rem 0.5rem; }
        .badge-personero { background-color: #0d6efd; }
        .badge-representante { background-color: #198754; }
        .foto-candidato { width: 50px; height: 50px; object-fit: cover; border-radius: 50%; }
        .filtros-busqueda { background-color: #f8f9fa; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem; }
    </style>
</head>
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-0">
                    ...
                    <div class="text-center mb-3">
                        <div class="position-relative d-inline-block">
                            <?php if (isset($_SESSION['admin_imagen']) && !empty($_SESSION['admin_imagen'])): ?>
                                <img src="<?= $_SESSION['admin_imagen'] ?>?v=<?= time() ?>" alt="<?= htmlspecialchars($admin_nombre) ?>"
                        ...
                        <div class="text-white-50 small"><?= htmlspecialchars($admin_nombre) ?></div>
                ...
                <ul class="nav flex-column px-2">
                    ...
                    <li class="nav-item">
                        <a href="/Login/admin/administrativos" class="sidebar-link">
                            <i class="fas fa-user-cog"></i> Administrativos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/Login/admin/candidatos" class="sidebar-link active">
                            <i class="fas fa-user-graduate"></i> Candidatos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="sidebar-link" data-bs-toggle="collapse" data-bs-target="#configuracionSubmenu" aria-expanded="false">
                            <i class="fas fa-cogs"></i> Configuración <i class="fas fa-chevron-down ms-auto"></i>
                        </a>
                        <div class="collapse" id="configuracionSubmenu">
                            <ul class="nav flex-column ms-3">
                                <li class="nav-item">
                                    <a href="/Login/admin/configuracion-elecciones" class="sidebar-link py-1">
                                        <i class="fas fa-calendar-alt"></i> Elecciones
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/Login/admin/logs-elecciones" class="sidebar-link py-1">
                                        <i class="fas fa-list-alt"></i> Logs de Elecciones
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/Login/admin/estado-elecciones" class="sidebar-link py-1">
                                        <i class="fas fa-info-circle"></i> Estado Actual
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/Login/admin/configuracion-sistema" class="sidebar-link py-1">
    ...
    <script>
        // JavaScript mínimo y limpio - SIN interceptores problemáticos
